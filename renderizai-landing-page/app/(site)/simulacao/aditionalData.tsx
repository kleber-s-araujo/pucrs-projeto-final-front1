const aditionalData = [
    {      
      rooms: [
        { type: 'fixed', id: 'limpeza', label: 'Limpeza do Arquivo', icon: '🛁' },
        { type: 'fixed', id: 'organizacao', label: 'Organização das Layers', icon: '🧺' },
        { type: 'fixed', id: 'enquadramento', label: 'Enquadramentop da Cena', icon: '🏠' },
        { type: 'fixed', id: 'refinamento', label: 'Correção e Refinamento da Modelagem', icon: '🛋️' },
