...
export const metadata: Metadata = {
    title: "Privacy Policies Page - Renderizaí",
      ...
      <section className="overflow-hidden pb-25 pt-45 lg:pb-32.5 lg:pt-50 xl:pb-37.5 xl:pt-55">
        <div className="animate_top mx-auto max-w-[800px] text-left">
          ...
          <ul className="mb-9 flex flex-wrap gap-5 2xl:gap-7.5">
            <li>
              <span className="text-black dark:text-white">Data de Vigência: </span>{" "}
              31/12/2025
            </li>
          </ul>
          ...
          <div className="blog-details">
            ...
            <ul className="mb-9 flex flex-wrap 2xl:gap-1.0">
              <li>
                <span className="text-black dark:text-white"><b>E-mail: </b> </span>{" "}
                email@email.com
              </li>
              <li>
                <span className="text-black dark:text-white"><b>Telefone: </b></span>{" "}
                (41) 3333-3333
              </li>
            </ul>
