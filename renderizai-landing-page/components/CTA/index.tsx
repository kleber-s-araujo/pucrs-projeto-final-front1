          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                Junte-se à nós e elimine o estresse e a incerteza
              </h2>
              <p>
                A Renderizaí oferece uma rede certificada de renderizadores 
                reduzindo o risco de falhas e atrasos, oferecendo um sistema de monitoramento de prazos.
              </p>
            </motion.div>
            <motion.div
              variants={{
